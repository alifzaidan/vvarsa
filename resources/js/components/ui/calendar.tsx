...
function Calendar({
  ...
  const fromYear = props.fromYear ?? (currentYear - 80);
  const toYear = props.toYear ?? (currentYear + 20);
  const captionLayout = props.captionLayout === "dropdown" ? "dropdown-buttons" : props.captionLayout;
      ...
      components={{
        ...
        Dropdown: ({ value, onChange, children, ...props }: DropdownProps) => {
          ...
          return (
            ...
            >
              <SelectTrigger className="h-8 min-w-[70px] text-xs py-1.5 px-2.5 font-medium border border-input rounded-md bg-background hover:bg-accent/50 focus-visible:ring-1 focus-visible:ring-ring/50 focus:ring-0 [&>span]:line-clamp-1">
